...
class _MapPageState extends State<MapPage> {
  ...
  static const LatLng _pApplePark = LatLng(32.5500, 35.8600);  // Another point in Irbid
    ...
    return Scaffold(
      body:_currentP==null? const Center(
        child: Column(
          ...
          children: [
            CircularProgressIndicator(color: Colors.blueAccent), // Loading spinner
            SizedBox(height: 16),
            Text(
              "Loading...",
              style: TextStyle(
      ...
      GoogleMap(
        ...
        markers: {
          Marker(
            ...
            icon: BitmapDescriptor.defaultMarkerWithHue(BitmapDescriptor.hueBlue), // Blue dot
            position: _currentP!,
