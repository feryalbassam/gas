...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Future<void> initializeProfile() async {
    await fetchUserData(); // Set userData as early as possible
  ...
  Future<void> uploadAssetImageToFirebase(String assetPath) async {
    ...
    try {
      await ref.getDownloadURL(); // If it exists, skip upload
      print("✅ Photo already exists, no need to upload asset");
      return;
    } catch (_) {
      print("⬆ Uploading default asset image...");
    }

    final byteData = await rootBundle.load(assetPath);
    final tempFile =
        File('${(await getTemporaryDirectory()).path}/temp_profile.png');
    ...
    print("✅ Default asset uploaded and Firestore updated");
  }
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
                  ...
                  child: GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: const Icon(Icons.edit,
                          color: Color(0xFF114195), size: 20),
                    ),
                  ),
                ),
              ],
            ...
            _buildOptionTile(
                context, Icons.person_outline, "Edit Profile", '/edit_profile'),
            _buildOptionTile(context, Icons.notifications_none_outlined,
                "Notification", '/notification'),
            _buildOptionTile(context, Icons.location_on_outlined,
